...
user_logs = get_logs_from('../full_logs/user_logs_group2.txt')
...
for i in range(0, len(user_logs), 10000):
    ...
    # 计算每一千条之后好之后开始存下来
    # scp.sparse.save_npz('../tmpData/sparse_matrix_%d_batch_group2.npz' % i, mat.tocsr())
    scp.sparse.save_npz('../tmpdata_iuf/sparse_matrix_%d_batch_group2.npz' % i, mat.tocsr())
